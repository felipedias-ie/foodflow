    ...
    <div className="min-h-screen bg-[#f8fbfa]">
              ...
              <div className="sticky top-28 border border-gray-200 rounded-lg bg-white p-6">
                ...
                {cart.length === 0 ? (
                  ...
                  <>
                    ...
                    <button className="w-full mt-4 flex items-center justify-center rounded-full h-12 px-6 bg-[#38e07b] text-gray-900 text-base font-bold hover:opacity-90 transition-opacity">
                      Go to Checkout
                    </button>
                  </>
                )}
      ...
      {cart.length > 0 && (
        <div className="xl:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 shadow-lg">
          <button className="w-full flex items-center justify-between rounded-full h-14 px-6 bg-[#38e07b] text-gray-900 font-bold hover:opacity-90 transition-opacity">
